...
void version_etc_arn(FILE* stream, char const* command_name, char const* package, char const* version, char const* const* authors, size_t n_authors)
{
...

    {
        ...
        {
            tmp = gettext("(C)");
            fprintf((FILE * /* __restrict  */) stream, (char const* /* __restrict  */)(version_etc_copyright), tmp, 2014);
    ...
    case_1:
    {
        ...
        fprintf((FILE * /* __restrict  */) stream, (char const* /* __restrict  */)((char const*)tmp___1), *(authors + 0));
    }
        goto switch_break;
    case_2:
    {
        tmp___2 = gettext("Written by %s and %s.\n");
        fprintf((FILE * /* __restrict  */) stream, (char const* /* __restrict  */)((char const*)tmp___2), *(authors + 0), *(authors + 1));
    }
        goto switch_break;
    case_3:
    {
        tmp___3 = gettext("Written by %s, %s, and %s.\n");
        fprintf((FILE * /* __restrict  */) stream, (char const* /* __restrict  */)((char const*)tmp___3), *(authors + 0), *(authors + 1), *(authors + 2));
    }
        goto switch_break;
    case_4:
    {
        tmp___4 = gettext("Written by %s, %s, %s,\nand %s.\n");
        fprintf((FILE * /* __restrict  */) stream, (char const* /* __restrict  */)((char const*)tmp___4), *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3));
    }
        goto switch_break;
    case_5:
    {
        tmp___5 = gettext("Written by %s, %s, %s,\n%s, and %s.\n");
        fprintf((FILE * /* __restrict  */) stream, (char const* /* __restrict  */)((char const*)tmp___5), *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3), *(authors + 4));
    }
        goto switch_break;
    case_6:
    {
        tmp___6 = gettext("Written by %s, %s, %s,\n%s, %s, and %s.\n");
        fprintf((FILE * /* __restrict  */) stream, (char const* /* __restrict  */)((char const*)tmp___6), *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3), *(authors + 4), *(authors + 5));
    }
        goto switch_break;
    case_7:
    {
        tmp___7 = gettext("Written by %s, %s, %s,\n%s, %s, %s, and %s.\n");
        fprintf((FILE * /* __restrict  */) stream, (char const* /* __restrict  */)((char const*)tmp___7), *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3), *(authors + 4), *(authors + 5), *(authors + 6));
    }
        goto switch_break;
    case_8:
    {
        tmp___8 = gettext("Written by %s, %s, %s,\n%s, %s, %s, %s,\nand %s.\n");
        fprintf((FILE * /* __restrict  */) stream, (char const* /* __restrict  */)((char const*)tmp___8), *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3), *(authors + 4), *(authors + 5), *(authors + 6), *(authors + 7));
    }
        goto switch_break;
    case_9:
    {
        tmp___9 = gettext("Written by %s, %s, %s,\n%s, %s, %s, %s,\n%s, and %s.\n");
        fprintf((FILE * /* __restrict  */) stream, (char const* /* __restrict  */)((char const*)tmp___9), *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3), *(authors + 4), *(authors + 5), *(authors + 6), *(authors + 7), *(authors + 8));
    }
        goto switch_break;
    switch_default:
    {
        tmp___10 = gettext("Written by %s, %s, %s,\n%s, %s, %s, %s,\n%s, %s, and others.\n");
        fprintf((FILE * /* __restrict  */) stream, (char const* /* __restrict  */)((char const*)tmp___10), *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3), *(authors + 4), *(authors + 5), *(authors + 6), *(authors + 7), *(authors + 8));
    }
        goto switch_break;
    switch_break:;
        return;
...
void mb_copy(mbchar_t* new_mbc, mbchar_t const* old_mbc)
{
...

    {
        ...
        {
            {
                memcpy((void* /* __restrict  */)((void*)(&new_mbc->buf[0])), (void const* /* __restrict  */)((void const*)(&old_mbc->buf[0])), (size_t)old_mbc->bytes);
...
void mbiter_multi_next(struct mbiter_multi* iter)
{
...

    {
        ...
        with_shift:
        {
            iter->cur.bytes = mbrtowc((wchar_t * /* __restrict  */)(&iter->cur.wc), (char const* /* __restrict  */)iter->cur.ptr, (size_t)(iter->limit - iter->cur.ptr), (mbstate_t * /* __restrict  */)(&iter->state));
        }
...
void mbuiter_multi_next(struct mbuiter_multi* iter)
{
...

    {
        ...
        with_shift:
        {
            ...
            iter->cur.bytes = mbrtowc((wchar_t * /* __restrict  */)(&iter->cur.wc), (char const* /* __restrict  */)iter->cur.ptr, tmp___1, (mbstate_t * /* __restrict  */)(&iter->state));
        }
            if (iter->cur.bytes == 0xffffffffffffffffUL)
            {
                iter->cur.bytes = (size_t)1;
...

    {
        ...
        if ((unsigned long)translation != (unsigned long)name)
        {
            ...
            else
            {
                ...
                {
                    result = (char*)tmp___6;
                    sprintf((char* /* __restrict  */)result, (char const* /* __restrict  */) "%s (%s)", translation, name);
                }
            ...
            if (tmp___12)
            {
                ...
                }
                {
                    ...
                    while_continue: /* CIL Label */;
                        ...
                        {
                            {
                                memcpy((void* /* __restrict  */)((void*)(&rhaystack)), (void const* /* __restrict  */)((void const*)(&iter_haystack)), sizeof(mbui_iterator_t));
                                rhaystack.cur.ptr += rhaystack.cur.bytes;
                                rhaystack.next_done = (_Bool)0;
...
static char const* get_charset_aliases(void)
{
...

    {
        ...
        if ((unsigned long)cp == (unsigned long)((void*)0))
        {
            ...
            {
                {
                    memcpy((void* /* __restrict  */)((void*)file_name___1), (void const* /* __restrict  */)((void const*)dir), dir_len___0);
                }
                if (add_slash)
                {
                    ...
                    else
                    {
                        ...
                        res_size = (size_t)0;
                        {
                            ...
                            while_continue: /* CIL Label */;
                                ...
                                {
                                    ungetc(c, fp);
                                    tmp___3 = fscanf((FILE * /* __restrict  */) fp, (char const* /* __restrict  */) "%50s %50s", buf1, buf2);
                                }
                                if (tmp___3 < 2)
                                {
                                    goto while_break;
...
_Bool exclude_patopts(struct patopts const* opts, char const* f)
{
...

    {
        ...
        {
            {
                tmp = regexec((regex_t const* /* __restrict  */)(&opts->v.re), (char const* /* __restrict  */)f, (size_t)0, (regmatch_t * /* __restrict  */)((regmatch_t*)((void*)0)), 0);
                tmp___1 = tmp == 0;
            }
        }
        else
        ...
        if (options & ((1 << 27) | (1 << 28)))
        {
            ...
            if (tmp___3)
            {
                ...
                if (options & (1 << 27))
                {
                        ...
                        {
                            {
                                ...
                                memcpy((void* /* __restrict  */)((void*)tmp___1), (void const* /* __restrict  */)((void const*)pattern), len);
                                strcpy((char* /* __restrict  */)(tmp___1 + len), (char const* /* __restrict  */) "(/.*)?");
                                rc = regcomp((regex_t * /* __restrict  */)(&patopts->v.re), (char const* /* __restrict  */)((char const*)tmp___1), cflags);
                                free((void*)tmp___1);
                            }
                        }
                    }
                    ...
                    {
                        {
                            rc = regcomp((regex_t * /* __restrict  */)(&patopts->v.re), (char const* /* __restrict  */)pattern, cflags);
                        }
                    }
                    if (rc)
                    {
        ...
        *n = (char)'\000';
        ...
        }
        {
            ...
            while_continue: /* CIL Label */;
                ...
                {
                    memcpy((void* /* __restrict  */)((void*)n), (void const* /* __restrict  */)((void const*)p), (size_t)(pnul - p));
                    n += pnul - p;
                    p = pnul;
                }
                {
                ...
                {
                    {
                        ...
                        *(buf + 0) = (char)eolbyte;
                        memcpy((void* /* __restrict  */)((void*)(buf + 1)), (void const* /* __restrict  */)((void const*)p), len);
                ...
                while_continue: /* CIL Label */;
                    ...
                    }
                    {
                        ...
                        *mp = (char)eolbyte;
                        ...
                        memcpy((void* /* __restrict  */)((void*)mp), (void const* /* __restrict  */)((void const*)dm->must), old_len);
                    }
                    if (dm->endline)
                    {
...
static size_t mbs_to_wchar(wint_t* pwc, char const* s, size_t n, struct dfa* d)
{
...

    {
        ...
        {
            {
                tmp = mbrtowc((wchar_t * /* __restrict  */)(&wch), (char const* /* __restrict  */)s, n, (mbstate_t * /* __restrict  */)(&d->mbs));
                nbytes = tmp;
            }
            if (0UL < nbytes)
            {
                        ...
                        {
                            {
                                ...
                                memcpy((void* /* __restrict  */)((void*)grps[ngrps].elems), (void const* /* __restrict  */)((void const*)grps[j].elems), sizeof(*(grps[j].elems + 0)) * grps[j].nelem);
...
static int match_mb_charset(struct dfa* d, state_num s, position pos, char const* p, wint_t wc, size_t match_len)
{
    ...
    while_break:
    {
        strncpy((char* /* __restrict  */)(buffer___0), (char const* /* __restrict  */)p, match_len);
    ...
    }
        {
            ...
            while_continue___0: /* CIL Label */;
                ...
                }
                {
                    ...
                    strncpy((char* /* __restrict  */)(buffer___0), (char const* /* __restrict  */)p, (size_t)op_len);
...

    {
        ...
        }
        {
            ...
            while_continue: /* CIL Label */;
                ...
                {
                    tmp = mbrtowc((wchar_t * /* __restrict  */)(&wc), (char const* /* __restrict  */)beg, (size_t)(end - beg), (mbstate_t * /* __restrict  */)(&is));
                    mbclen = tmp;
                }
...
wint_t mb_next_wc(char const* cur, char const* end)
{
...

    {
        ...
        {
            {
                tmp___1 = mbrtowc((wchar_t * /* __restrict  */)(&wc), (char const* /* __restrict  */)cur, (size_t)(end - cur), (mbstate_t * /* __restrict  */)(&mbs));
            }
            ...
            while_continue: /* CIL Label */;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            fwrite_unlocked((void const* /* __restrict  */)((void const*)cur), sizeof(char), (size_t)(b - cur), (FILE * /* __restrict  */) stdout);
                        }
                    }
                    {
                        pr_sgr_start_if(match_color);
                        fwrite_unlocked((void const* /* __restrict  */)((void const*)b), sizeof(char), match_size, (FILE * /* __restrict  */) stdout);
...
static char const* print_line_tail(char const* beg, char const* lim, char const* line_color)
{
...

    {
        ...
        if (tail_size > 0UL)
        {
            {
                pr_sgr_start(line_color);
                fwrite_unlocked((void const* /* __restrict  */)((void const*)beg), (size_t)1, tail_size, (FILE * /* __restrict  */) stdout);
                beg += tail_size;
        ...
        else if ((unsigned int)devices == 0U)
        {
            ...
            _L:
                if (!st->st_mode)
                {
                    ...
                    {
                        flag = tmp___4;
                        tmp___6 = fstatat(fts->fts_cwd_fd, (char const* /* __restrict  */)((char const*)ent->fts_accpath), (struct stat * /* __restrict  */)(&st1), flag);
                    }
                    if (tmp___6 != 0)
                    {
                        {
        ...
        {
            {
                ...
                fprintf((FILE * /* __restrict  */) stderr, (char const* /* __restrict  */)((char const*)tmp___0), program_name);
            }
        }
        else
        {
...

    {
        ...
        }
        {
            ...
            while_continue: /* CIL Label */;
                ...
                {
                    n = mbrtowc((wchar_t * /* __restrict  */)(&wc), (char const* /* __restrict  */)keys, len, (mbstate_t * /* __restrict  */)(&mb_state));
                }
            ...
            switch_default:
            {
                p = (char*)mempcpy((void* /* __restrict  */)((void*)p), (void const* /* __restrict  */)((void const*)keys), n);
            }
                goto switch_break;
        ...
        }
        {
            ...
            while_break___0:
            {
            ...
            }
                {
                    ...
                    while_continue___1: /* CIL Label */;
                        {
                            cc = fread_unlocked((void* /* __restrict  */)((void*)(keys + keycc)), (size_t)1, (keyalloc - 1UL) - keycc, (FILE * /* __restrict  */) fp);
                        }
                        if (!(cc != 0UL))
                        {
                            goto while_break___1;
