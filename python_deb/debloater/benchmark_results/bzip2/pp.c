...
Int32 BZ2_decompress(DState *s)
{
  ...
  void *__cil_tmp92;
  {
    ...
    retVal = 0;
    {
      ...
      {
        {
          fprintf((FILE *) stderr, (const char *) "rt+rld");
        }
      }
...
static void sendMTFValues(EState *s)
{
  ...
  void *__cil_tmp43;
  {
    ...
    {
      {
        fprintf((FILE *) stderr, (const char *) "      %d in block, %d after MTF & 1-2 coding, %d+2 syms in use\n", s->nblock, s->nMTF, s->nInUse);
      }
    }
    ...
    gs = 0;
    {
      while (1)
      {
        ...
        {
          {
            fprintf((FILE *) stderr, (const char *) "      initial group %d, [%d .. %d], has %d syms (%4.1f%%)\n", nPart, gs, ge, aFreq, (100.0 * ((double) ((float) aFreq))) / ((double) ((float) s->nMTF)));
          }
        }
    ...
    iter = 0;
    {
      while (1)
      {
        ...
        {
          {
            fprintf((FILE *) stderr, (const char *) "      pass %d: size is %d, grp uses are ", iter + 1, totc / 8);
            t = 0;
          }
          {
            while (1)
            {
              ...
              {
                fprintf((FILE *) stderr, (const char *) "%d ", fave[t]);
                t++;
              }
            }
    ...
    {
      {
        fprintf((FILE *) stderr, (const char *) "      bytes: mapping %d, ", s->numZ - nBytes);
      }
    }
    ...
    {
      {
        fprintf((FILE *) stderr, (const char *) "selectors %d, ", s->numZ - nBytes);
      }
    }
    ...
    {
      {
        fprintf((FILE *) stderr, (const char *) "code lengths %d, ", s->numZ - nBytes);
      }
    }
    ...
    {
      {
        fprintf((FILE *) stderr, (const char *) "codes %d\n", s->numZ - nBytes);
      }
    }
...
{
  {
    if (s->nblock > 0)
    {
      ...
      {
        {
          fprintf((FILE *) stderr, (const char *) "    block %d: crc = 0x%08x, combined CRC = 0x%08x, size = %d\n", s->blockNo, s->blockCRC, s->combinedCRC, s->nblock);
        }
      }
    ...
    if (is_last_block)
    {
      ...
      {
        {
          fprintf((FILE *) stderr, (const char *) "    final combined CRC = 0x%08x\n   ", s->combinedCRC);
        }
      }
        ...
        if (s->state == 2)
        {
          ...
          if (s->nblock_used == (s->save_nblock + 1))
          {
            if (s->state_out_len == 0)
            {
              ...
              {
                {
                  fprintf((FILE *) stderr, (const char *) " {0x%08x, 0x%08x}", s->storedBlockCRC, s->calculatedBlockCRC);
                }
              }
...
static const char *bzerrorstrings[16] = {"OK", "SEQUENCE_ERROR", "PARAM_ERROR", "MEM_ERROR", "DATA_ERROR", "DATA_ERROR_MAGIC", "IO_ERROR", "UNEXPECTED_EOF", "OUTBUFF_FULL", "CONFIG_ERROR", "???", "???", "???", "???", "???", "???"};
  ...
  char *__cil_tmp34;
  {
    ...
    if (verbosity >= 1)
    {
      if (nbytes_in_lo32 == 0U)
      {
        ...
        {
          {
            fprintf((FILE *) stderr, (const char *) " no data compressed.\n");
          }
        }
        else
        {
    ...
    if (forceOverwrite)
    {
      ...
      }
      {
        while (1)
        {
          ...
          {
            nread = (Int32) fread((void *) obuf, sizeof(UChar), (size_t) 5000, (FILE *) zStream);
...
static Bool testStream(FILE *zStream)
{
  ...
  char *__cil_tmp22;
  {
...

    {
      ...
      case_neg_4:
      {
        fprintf((FILE *) stderr, (const char *) "data integrity (CRC) error in data\n");
      }
      ...
      case_neg_7:
      {
        fprintf((FILE *) stderr, (const char *) "file ends unexpectedly\n");
      }
      ...
      else
      {
        ...
        {
          {
            fprintf((FILE *) stderr, (const char *) "trailing garbage after EOF ignored\n");
          }
        }
...
{
  {
    ...
    {
      {
        fprintf((FILE *) stderr, (const char *) "\tInput file = %s, output file = %s\n", inName, outName);
      }
    }
  ...
  void *__cil_tmp4;
  {
    if (srcMode == 3)
    {
      if (opMode != 3)
      {
        ...
        {
          {
            retVal = stat((const char *) inName, (struct stat *) (& statBuf));
          }
          if (retVal == 0)
          {
            if (noisy)
            {
              {
                fprintf((FILE *) stderr, (const char *) "%s: Deleting output file %s, if it exists.\n", progName, outName);
              }
            }
            ...
            {
              retVal = remove((const char *) outName);
            }
            if (retVal != 0)
            {
              {
                fprintf((FILE *) stderr, (const char *) "%s: WARNING: deletion of output file (apparently) failed.\n", progName);
              }
            }
          ...
          {
            {
              fprintf((FILE *) stderr, (const char *) "%s: WARNING: deletion of output file suppressed\n", progName);
              fprintf((FILE *) stderr, (const char *) "%s:    since input file no longer exists.  Output file\n", progName);
              fprintf((FILE *) stderr, (const char *) "%s:    `%s\' may be incomplete.\n", progName, outName);
              fprintf((FILE *) stderr, (const char *) "%s:    I suggest doing an integrity test (bzip2 -tv) of it.\n", progName);
            }
          }
    ...
    if (noisy)
    {
      if (numFileNames > 0)
      {
        ...
        {
          {
            fprintf((FILE *) stderr, (const char *) "%s: WARNING: some files have not been processed:\n%s:    %d specified on command line, %d not processed yet.\n\n", progName, progName, numFileNames, numFileNames - numFilesProcessed);
          }
        }
...
static void configError(void)
{
  {
    {
      fprintf((FILE *) stderr, (const char *) "bzip2: I\'m not configured correctly for this platform!\n\tI require Int32, Int16 and Char to have sizes\n\tof 4, 2 and 1 bytes to run properly, and they don\'t.\n\tProbably you can fix this by defining them correctly,\n\tand recompiling.  Bye!\n");
      setExit(3);
      exit(exitValue);
    }
  }
...
static void copyFileName(Char *to, Char *from)
{
  size_t tmp;
  {
    ...
    {
      {
        fprintf((FILE *) stderr, (const char *) "bzip2: file name\n`%s\'\nis suspiciously (more than %d chars) long.\nTry using a reasonable file name instead.  Sorry! :-)\n", from, 1024);
        setExit(1);
        exit(exitValue);
      }
    }
...
static FILE *fopen_output_safely(Char *name, const char *mode)
{
  ...
  {
    {
      fh = open((const char *) name, 193, 384);
    }
    if (fh == (- 1))
    {
      return (FILE *) ((void *) 0);
...
static void saveInputFileMetaInfo(Char *srcName)
{
  ...
  {
    {
      retVal = stat((const char *) srcName, (struct stat *) (& fileMetaInfo));
    }
    if (retVal != 0)
    {
      {
  ...
  {
    {
      ...
      retVal = utime((const char *) dstName, (const struct utimbuf *) (& uTimBuf));
    }
    if (retVal != 0)
    {
      {
  ...
  size_t tmp___1;
  {
...

    {
      ...
      * (name + (tmp___0 - tmp___1)) = (Char) 0;
      strcat((char *) name, (const char *) newSuffix);
    }
    return (Bool) 1;
  }
}
  ...
  char *__cil_tmp36;
  {
    ...
    if (srcMode != 1)
    {
      ...
      if (tmp)
      {
        ...
        {
          {
            fprintf((FILE *) stderr, (const char *) "%s: There are no files matching `%s\'.\n", progName, inName);
          }
        }
      ...
      {
        {
          ...
          fprintf((FILE *) stderr, (const char *) "%s: Can\'t open input file %s: %s.\n", progName, inName, tmp___1);
          setExit(1);
        }
        return;
      }
      ...
      if (srcMode == 2)
    {
      ...
      {
        {
          fprintf((FILE *) stderr, (const char *) "%s: Input file %s is a directory.\n", progName, inName);
          setExit(1);
        }
        return;
      }
    ...
    if (srcMode == 3)
    {
      if (! forceOverwrite)
      {
        ...
        if (tmp___4)
        {
          ...
          {
            {
              fprintf((FILE *) stderr, (const char *) "%s: Input file %s is not a normal file.\n", progName, inName);
            }
          }
    ...
    if (srcMode == 3)
    {
      if (! forceOverwrite)
      {
        ...
        if (n > 0)
        {
          ...
          {
            fprintf((FILE *) stderr, (const char *) "%s: Input file %s has %d other link%s.\n", progName, inName, n, tmp___6);
            setExit(1);
          }
          return;
        }
...

    {
      ...
      {
        {
          fprintf((FILE *) stderr, (const char *) "%s: I won\'t write compressed data to a terminal.\n", progName);
          fprintf((FILE *) stderr, (const char *) "%s: For help, type: `%s --help\'.\n", progName, progName);
          setExit(1);
        }
        return;
      }
      ...
      {
        {
          ...
          fprintf((FILE *) stderr, (const char *) "%s: Can\'t create output file %s: %s.\n", progName, outName, tmp___14);
        }
        if (((unsigned long) inStr) != ((unsigned long) ((void *) 0)))
        {
          {
    ...
    {
      {
        fprintf((FILE *) stderr, (const char *) "  %s: ", inName);
        pad(inName);
        fflush(stderr);
      }
    }
    ...
    if (srcMode == 3)
    {
      ...
      {
        {
          tmp___17 = remove((const char *) inName);
          retVal = tmp___17;
        }
        if (retVal != 0)
        {
...
static void uncompress(Char *name)
{
  ...
  char *__cil_tmp38;
  {
    ...
    cantGuess = (Bool) 0;
    {
      ...
      {
        cantGuess = (Bool) 1;
        strcat((char *) outName, (const char *) ".out");
      }
      goto switch_break;
      case_2:
      {
    ...
    if (cantGuess)
    {
      ...
      {
        {
          fprintf((FILE *) stderr, (const char *) "%s: Can\'t guess original name for %s -- using %s\n", progName, inName, outName);
        }
      }
...

    {
      ...
      {
        {
          fprintf((FILE *) stderr, (const char *) "%s: I won\'t read compressed data from a terminal.\n", progName);
          fprintf((FILE *) stderr, (const char *) "%s: For help, type: `%s --help\'.\n", progName, progName);
          setExit(1);
        }
        return;
    ...
    if (magicNumberOK)
    {
      if (srcMode == 3)
      {
        ...
        {
          {
            tmp___15 = remove((const char *) inName);
            retVal = tmp___15;
          }
          if (retVal != 0)
          {
    ...
    else
    {
      ...
      {
        {
          tmp___16 = remove((const char *) outName);
          retVal___0 = tmp___16;
        }
        if (retVal___0 != 0)
        {
    ...
    if (magicNumberOK)
    {
      ...
      {
        {
          fprintf((FILE *) stderr, (const char *) "done\n");
        }
      }
    ...
    else
    {
      ...
      {
        {
          fprintf((FILE *) stderr, (const char *) "not a bzip2 file.\n");
        }
      }
      else
      {
        {
          fprintf((FILE *) stderr, (const char *) "%s: %s is not a bzip2 file.\n", progName, inName);
        }
      }
      ...
      {
        {
          tmp___0 = __errno_location();
          tmp___1 = strerror(* tmp___0);
          fprintf((FILE *) stderr, (const char *) "%s: Can\'t open input %s: %s.\n", progName, inName, tmp___1);
          setExit(1);
        }
        return;
      }
...
static void redundant(Char *flag)
{
  {
    {
      fprintf((FILE *) stderr, (const char *) "%s: %s is redundant in versions 0.9.5 and above\n", progName, flag);
    }
    return;
  }
}
          ...
          }
          {
            while (1)
            {
              ...
              if (((int) (* (p + i))) != 0)
              {
                ...
                if (((const int) (* ((* tmp___0) + ((Int32) (* (p + i)))))) & 8192)
                {
                  goto while_break___1;
                }
...
IntNative main(IntNative argc, Char **argv)
{
  ...
  char *__cil_tmp45;
  {
            ...
            j = 1;
            {
              while (1)
              {
...

                {
                  ...
                  switch_default:
                  {
                    fprintf((FILE *) stderr, (const char *) "%s: Bad flag `%s\'\n", progName, aa->name);
                    usage(progName);
                    exit(1);
                  }
    ...
    if (opMode == 3)
    {
      ...
      {
        {
          fprintf((FILE *) stderr, (const char *) "%s: -c and -t cannot be used together.\n", progName);
          exit(1);
        }
      }
      ...
      else
      {
        ...
        aa = argList;
        {
          while (1)
          {
            ...
            {
              tmp___30 = strcmp((const char *) aa->name, "--");
            }
            if (tmp___30 == 0)
            {
              decode = (Bool) 0;
...
static void fallbackSort(UInt32 *fmap, UInt32 *eclass, UInt32 *bhtab, Int32 nblock, Int32 verb)
{
  ...
  void *__cil_tmp20;
  {
    ...
    {
      {
        fprintf((FILE *) stderr, (const char *) "        bucket sorting ...\n");
      }
    }
    ...
    H = 1;
    {
      while (1)
      {
        ...
        {
          {
            fprintf((FILE *) stderr, (const char *) "        depth %6d has ", H);
          }
        }
        ...
        {
          {
            fprintf((FILE *) stderr, (const char *) "%6d unresolved strings\n", nNotDone);
          }
        }
    ...
    {
      {
        fprintf((FILE *) stderr, (const char *) "        reconstructing block ...\n");
      }
    }
...
static void mainSort(UInt32 *ptr, UChar *block, UInt16 *quadrant, UInt32 *ftab, Int32 nblock, Int32 verb, Int32 *budget)
{
  ...
  void *__cil_tmp34;
  {
    ...
    {
      {
        fprintf((FILE *) stderr, (const char *) "        main sort initialise ...\n");
      }
    }
            ...
            if (j != ss)
            {
              ...
              if (! ((* (ftab + sb)) & ((unsigned int) (1 << 21))))
              {
                ...
                if (hi > lo)
                {
                  ...
                  {
                    {
                      fprintf((FILE *) stderr, (const char *) "        qsort [0x%x, 0x%x]   done %d   this %d\n", ss, j, numQSorted, (hi - lo) + 1);
                    }
                  }
    ...
    {
      {
        fprintf((FILE *) stderr, (const char *) "        %d pointers, %d sorted, %d scanned\n", nblock, numQSorted, nblock - numQSorted);
      }
    }
  ...
  int tmp;
  {
    ...
    else
    {
      ...
      if (budget < 0)
      {
        ...
        {
          {
            fprintf((FILE *) stderr, (const char *) "    too repetitive; using fallback sorting algorithm\n");
          }
        }
