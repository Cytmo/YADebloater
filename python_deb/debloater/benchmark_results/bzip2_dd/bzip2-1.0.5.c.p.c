...
Int32 BZ2_decompress(DState *s )
{
  ...
  if (s->verbosity >= 2) {
    {
    fprintf((FILE * )stderr, (char const * )"rt+rld");
    }
  }
  if (s->smallDecompress) {
    i = 0;
...
static void sendMTFValues(EState *s )
{
  ...
  if (s->verbosity >= 3) {
    {
    fprintf((FILE * )stderr, (char const * )"      %d in block, %d after MTF & 1-2 coding, %d+2 syms in use\n",
  ...
  while (1) {
    ...
    if (s->verbosity >= 3) {
      {
      fprintf((FILE * )stderr, (char const * )"      initial group %d, [%d .. %d], has %d syms (%4.1f%%)\n",
  ...
  while (1) {
    ...
    if (s->verbosity >= 3) {
      {
      fprintf((FILE * )stderr, (char const * )"      pass %d: size is %d, grp uses are ",
              iter + 1, totc / 8);
      t = 0;
      }
      {
      while (1) {
        ...
        {
        fprintf((FILE * )stderr, (char const * )"%d ",
                fave[t]);
        t ++;
        }
      }
  ...
  if (s->verbosity >= 3) {
    {
    fprintf((FILE * )stderr, (char const * )"      bytes: mapping %d, ",
            s->numZ - nBytes);
    }
  }
  {
  ...
  if (s->verbosity >= 3) {
    {
    fprintf((FILE * )stderr, (char const * )"selectors %d, ",
            s->numZ - nBytes);
    }
  }
  nBytes = s->numZ;
  ...
  if (s->verbosity >= 3) {
    {
    fprintf((FILE * )stderr, (char const * )"code lengths %d, ",
            s->numZ - nBytes);
    }
  }
  nBytes = s->numZ;
  ...
  if (s->verbosity >= 3) {
    {
    fprintf((FILE * )stderr, (char const * )"codes %d\n",
            s->numZ - nBytes);
    }
  }
  return;
...
void BZ2_compressBlock(EState *s , Bool is_last_block )
{
  ...
  if (s->nblock > 0) {
    ...
    if (s->verbosity >= 2) {
      {
      fprintf((FILE * )stderr, (char const * )"    block %d: crc = 0x%08x, combined CRC = 0x%08x, size = %d\n",
  ...
  if (is_last_block) {
    ...
    if (s->verbosity >= 2) {
      {
      fprintf((FILE * )stderr, (char const * )"    final combined CRC = 0x%08x\n   ",
              s->combinedCRC);
      }
    }
    {
    ...
    if (s->state == 2) {
      ...
      if (s->nblock_used == s->save_nblock + 1) {
        if (s->state_out_len == 0) {
          ...
          if (s->verbosity >= 3) {
            {
            fprintf((FILE * )stderr, (char const * )" {0x%08x, 0x%08x}",
...
void BZ2_bzWrite(int *bzerror , BZFILE *b , void *buf , int len )
{
  ...
  while (1) {
    ...
    if (bzf->strm.avail_out < 5000U) {
      ...
      n2 = (Int32 )fwrite((void const * )((void *)(bzf->buf)), sizeof(UChar ),
                          (size_t )n, (FILE * )bzf->handle);
      }
      if (n != n2) {
        goto _L___0;
      } else {
    ...
    if (bzf->lastErr == 0) {
      ...
      while (1) {
        ...
        if (bzf->strm.avail_out < 5000U) {
          {
          n = (Int32 )(5000U - bzf->strm.avail_out);
          n2 = (Int32 )fwrite((void const * )((void *)(bzf->buf)),
                              sizeof(UChar ), (size_t )n, (FILE * )bzf->handle);
          }
          if (n != n2) {
            goto _L;
          } else {
...
int BZ2_bzRead(int *bzerror , BZFILE *b , void *buf , int len )
{
  ...
  while (1) {
    ...
    if (bzf->strm.avail_in == 0U) {
      ...
      if (! tmp___1) {
        {
        n = (Int32 )fread((void * )(bzf->buf), sizeof(UChar ), (size_t )5000,
                          (FILE * )bzf->handle);
        tmp___0 = ferror(bzf->handle);
        }
        if (tmp___0) {
...
extern int ( strncmp)(char const *__s1 ,
                                                                                                char const *__s2 ,
                                                                                                size_t __n ) ;
extern char *( strstr)(char const *__haystack ,
                                                                                                 char const *__needle ) ;
...
extern int ( open)(char const *__file , int __oflag
                                                   , ...) __asm__("open64") ;
extern int ( utime)(char const *__file ,
...
static void compressStream(FILE *stream , FILE *zStream )
{
  ...
  while (1) {
    ...
    {
    nIbuf = (Int32 )fread((void * )(ibuf), sizeof(UChar ), (size_t )5000,
                          (FILE * )stream);
  ...
  if (verbosity >= 1) {
    if (nbytes_in_lo32 == 0U) {
      if (nbytes_in_hi32 == 0U) {
        {
        fprintf((FILE * )stderr, (char const * )" no data compressed.\n");
        }
      } else {
        goto _L;
      }
      ...
      fprintf((FILE * )stderr, (char const * )"%6.3f:1, %6.3f bits/byte, %5.2f%% saved, %s in, %s out.\n",
...
static Bool uncompressStream(FILE *zStream , FILE *stream )
{
  ...
  while (1) {
    ...
    while (1) {
      ...
      if (bzerr == 4) {
        ...
        if (nread > 0) {
          {
          fwrite((void const * )(obuf), sizeof(UChar ), (size_t )nread,
                 (FILE * )stream);
          }
        }
      }
  ...
  if (forceOverwrite) {
    ...
    while (1) {
      ...
      {
      nread = (Int32 )fread((void * )(obuf), sizeof(UChar ), (size_t )5000,
                            (FILE * )zStream);
...
static Bool testStream(FILE *zStream )
{
  ...
  if (verbosity == 0) {
    {
    fprintf((FILE * )stderr, (char const * )"%s: %s: ",
            progName, inName);
    }
  }
  {
  ...
  case_neg_4:
  {
  fprintf((FILE * )stderr, (char const * )"data integrity (CRC) error in data\n");
  }
  return ((Bool )0);
  case_neg_3:
  {
  ...
  case_neg_7:
  {
  fprintf((FILE * )stderr, (char const * )"file ends unexpectedly\n");
  }
  return ((Bool )0);
  case_neg_5:
  if ((unsigned long )zStream != (unsigned long )stdin) {
  ...
  if (streamNo == 1) {
    {
    fprintf((FILE * )stderr, (char const * )"bad magic number (file not created by bzip2)\n");
    }
    return ((Bool )0);
  } else {
    if (noisy) {
      {
      fprintf((FILE * )stderr, (char const * )"trailing garbage after EOF ignored\n");
      }
    }
    return ((Bool )1);
  }
...
static void showFileNames(void)
{
  ...
  if (noisy) {
    {
    fprintf((FILE * )stderr, (char const * )"\tInput file = %s, output file = %s\n",
            inName, outName);
    }
  }
  return;
  ...
  if (srcMode == 3) {
    if (opMode != 3) {
      if (deleteOutputOnInterrupt) {
        {
        retVal = stat((char const * )(inName), (struct stat * )(& statBuf));
        }
        if (retVal == 0) {
          if (noisy) {
            {
            fprintf((FILE * )stderr, (char const * )"%s: Deleting output file %s, if it exists.\n",
                    progName, outName);
            }
          }
          ...
          if (retVal != 0) {
            {
            fprintf((FILE * )stderr, (char const * )"%s: WARNING: deletion of output file (apparently) failed.\n",
                    progName);
            }
          }
        } else {
          {
          fprintf((FILE * )stderr, (char const * )"%s: WARNING: deletion of output file suppressed\n",
                  progName);
          fprintf((FILE * )stderr, (char const * )"%s:    since input file no longer exists.  Output file\n",
                  progName);
          fprintf((FILE * )stderr, (char const * )"%s:    `%s\' may be incomplete.\n",
                  progName, outName);
          fprintf((FILE * )stderr, (char const * )"%s:    I suggest doing an integrity test (bzip2 -tv) of it.\n",
                  progName);
          }
        }
      }
  ...
  if (noisy) {
    if (numFileNames > 0) {
      if (numFilesProcessed < numFileNames) {
        {
        fprintf((FILE * )stderr, (char const * )"%s: WARNING: some files have not been processed:\n%s:    %d specified on command line, %d not processed yet.\n\n",
...
static void configError(void)
{
  ...
  {
  {
  fprintf((FILE * )stderr, (char const * )"bzip2: I\'m not configured correctly for this platform!\n\tI require Int32, Int16 and Char to have sizes\n\tof 4, 2 and 1 bytes to run properly, and they don\'t.\n\tProbably you can fix this by defining them correctly,\n\tand recompiling.  Bye!\n");
  setExit(3);
  exit(exitValue);
  }
}
...
static void copyFileName(Char *to , Char *from )
{
  ...
  if (tmp > 1024UL) {
    {
    fprintf((FILE * )stderr, (char const * )"bzip2: file name\n`%s\'\nis suspiciously (more than %d chars) long.\nTry using a reasonable file name instead.  Sorry! :-)\n",
            from, 1024);
    setExit(1);
    exit(exitValue);
    }
  ...
  {
  strncpy((char * )to, (char const * )from, (size_t )1024);
  *(to + 1024) = (Char )'\000';
  }
  return;
}
...
static Bool fileExists(Char *name )
{
  ...
  {
  {
  tmp___0 = fopen((char const * )name, (char const * )"rb");
  tmp = tmp___0;
...
static Bool notAStandardFile(Char *name )
{
  ...
  {
  {
  i = lstat((char const * )name, (struct stat * )(& statBuf));
  }
  if (i != 0) {
    return ((Bool )1);
  }
...
static void saveInputFileMetaInfo(Char *srcName )
{
  ...
  {
  {
  retVal = stat((char const * )srcName, (struct stat * )(& fileMetaInfo));
  }
  if (retVal != 0) {
    {
    ioError();
...
static Bool mapSuffix(Char *name , Char const *oldSuffix , Char const *newSuffix )
{
  ...
  *(name + (tmp___0 - tmp___1)) = (Char )0;
  strcat((char * )name, (char const * )newSuffix);
  }
  return ((Bool )1);
}
}
static void compress(Char *name )
{
  ...
  strcat((char * )(outName), (char const * )".bz2");
  }
  goto switch_break;
  case_2:
  {
  ...
  if (srcMode != 1) {
    ...
    if (tmp) {
      if (noisy) {
        {
        fprintf((FILE * )stderr, (char const * )"%s: There are no files matching `%s\'.\n",
                progName, inName);
        }
      }
      {
  ...
  if (srcMode != 1) {
    ...
    if (! tmp___2) {
      ...
      fprintf((FILE * )stderr, (char const * )"%s: Can\'t open input file %s: %s.\n",
  ...
  while (1) {
    ...
    if (tmp___3) {
      if (noisy) {
        {
        fprintf((FILE * )stderr, (char const * )"%s: Input file %s already has %s suffix.\n",
  ...
  if (srcMode == 2) {
    _L:
    {
    stat((char const * )(inName), (struct stat * )(& statBuf));
    }
    if ((statBuf.st_mode & 61440U) == 16384U) {
      {
      fprintf((FILE * )stderr, (char const * )"%s: Input file %s is a directory.\n",
              progName, inName);
      setExit(1);
      }
      return;
  ...
  if (srcMode == 3) {
    if (! forceOverwrite) {
      ...
      if (tmp___4) {
        if (noisy) {
          {
          fprintf((FILE * )stderr, (char const * )"%s: Input file %s is not a normal file.\n",
                  progName, inName);
          }
        }
        {
  ...
  if (srcMode == 3) {
    ...
    if (tmp___5) {
      if (forceOverwrite) {
        ...
        {
        fprintf((FILE * )stderr, (char const * )"%s: Output file %s already exists.\n",
                progName, outName);
        setExit(1);
        }
        return;
  ...
  if (srcMode == 3) {
    if (! forceOverwrite) {
      ...
      if (n > 0) {
        ...
        {
        fprintf((FILE * )stderr, (char const * )"%s: Input file %s has %d other link%s.\n",
  ...
  if (tmp___8) {
    {
    fprintf((FILE * )stderr, (char const * )"%s: I won\'t write compressed data to a terminal.\n",
            progName);
    fprintf((FILE * )stderr, (char const * )"%s: For help, type: `%s --help\'.\n",
            progName, progName);
    setExit(1);
    }
    return;
  ...
  case_2___0:
  {
  inStr = fopen((char const * )(inName), (char const * )"rb");
  outStr = stdout;
  ...
  if ((unsigned long )outStr == (unsigned long )((void *)0)) {
    ...
    fprintf((FILE * )stderr, (char const * )"%s: Can\'t create output file %s: %s.\n",
...
static void uncompress(Char *name )
{
  ...
  {
  cantGuess = (Bool )1;
  strcat((char * )(outName), (char const * )".out");
  }
  goto switch_break;
  case_2:
  {
  ...
  if (cantGuess) {
    if (noisy) {
      {
      fprintf((FILE * )stderr, (char const * )"%s: Can\'t guess original name for %s -- using %s\n",
  ...
  if (tmp___8) {
    {
    fprintf((FILE * )stderr, (char const * )"%s: I won\'t read compressed data from a terminal.\n",
            progName);
    fprintf((FILE * )stderr, (char const * )"%s: For help, type: `%s --help\'.\n",
            progName, progName);
    setExit(1);
  ...
  if (magicNumberOK) {
    if (verbosity >= 1) {
      {
      fprintf((FILE * )stderr, (char const * )"done\n");
      }
    }
  } else {
    {
    ...
    if (verbosity >= 1) {
      {
      fprintf((FILE * )stderr, (char const * )"not a bzip2 file.\n");
      }
    } else {
      {
      fprintf((FILE * )stderr, (char const * )"%s: %s is not a bzip2 file.\n",
              progName, inName);
      }
    }
  }
...
static void testf(Char *name )
{
  ...
  if (srcMode != 1) {
    ...
    if (! tmp___2) {
      ...
      tmp___0 = __errno_location();
      tmp___1 = strerror(*tmp___0);
      fprintf((FILE * )stderr, (char const * )"%s: Can\'t open input %s: %s.\n",
              progName, inName, tmp___1);
      setExit(1);
      }
      return;
  ...
  if (allOK) {
    if (verbosity >= 1) {
      {
      fprintf((FILE * )stderr, (char const * )"ok\n");
      }
    }
  }
  if (! allOK) {
...
static void redundant(Char *flag )
{
  ...
  {
  {
  fprintf((FILE * )stderr, (char const * )"%s: %s is redundant in versions 0.9.5 and above\n",
          progName, flag);
  }
  return;
}
...
static Cell *snocString(Cell *root , Char *name )
{
  ...
  if ((unsigned long )root == (unsigned long )((void *)0)) {
    ...
    strcpy((char * )tmp->name, (char const * )name);
    }
    return (tmp);
  } else {
    tmp___3 = root;
...
IntNative main(IntNative argc , Char **argv )
{
    ...
    if ((int )*(aa->name + 0) == 45) {
      if ((int )*(aa->name + 1) != 45) {
        ...
        while (1) {
          ...
          switch_default:
          {
          fprintf((FILE * )stderr, (char const * )"%s: Bad flag `%s\'\n",
                  progName, aa->name);
          usage(progName);
          exit(1);
          }
  ...
  if (opMode == 3) {
    if (srcMode == 2) {
      {
      fprintf((FILE * )stderr, (char const * )"%s: -c and -t cannot be used together.\n",
              progName);
      exit(1);
      }
    }
                         ...
                         Int32 verb )
{
  ...
  if (verb >= 4) {
    {
    fprintf((FILE * )stderr, (char const * )"        bucket sorting ...\n");
    }
  }
  i = 0;
  {
  ...
  while (1) {
    ...
    if (verb >= 4) {
      {
      fprintf((FILE * )stderr, (char const * )"        depth %6d has ",
              H);
      }
    }
    j = 0;
    ...
    if (verb >= 4) {
      {
      fprintf((FILE * )stderr, (char const * )"%6d unresolved strings\n",
              nNotDone);
      }
    }
    H *= 2;
  ...
  if (verb >= 4) {
    {
    fprintf((FILE * )stderr, (char const * )"        reconstructing block ...\n");
    }
  }
  j = 0;
  i = 0;
                     ...
                     Int32 nblock , Int32 verb , Int32 *budget )
{
  ...
  if (verb >= 4) {
    {
    fprintf((FILE * )stderr, (char const * )"        main sort initialise ...\n");
    }
  }
  i = 65536;
  {
      ...
      if (j != ss) {
        ...
        if (! (*(ftab + sb) & (unsigned int )(1 << 21))) {
          ...
          if (hi > lo) {
            if (verb >= 4) {
              {
              fprintf((FILE * )stderr, (char const * )"        qsort [0x%x, 0x%x]   done %d   this %d\n",
  ...
  if (verb >= 4) {
    {
    fprintf((FILE * )stderr, (char const * )"        %d pointers, %d sorted, %d scanned\n",
...
void BZ2_blockSort(EState *s )
{
  ...
  if (nblock < 10000) {
    ...
    if (verb >= 3) {
      ...
      {
      fprintf((FILE * )stderr, (char const * )"      %d work, %d block, ratio %5.2f\n",
    ...
    if (budget < 0) {
      if (verb >= 2) {
        {
        fprintf((FILE * )stderr, (char const * )"    too repetitive; using fallback sorting algorithm\n");
        }
      }
      {
      fallbackSort(s->arr1, s->arr2, ftab, nblock, verb);
