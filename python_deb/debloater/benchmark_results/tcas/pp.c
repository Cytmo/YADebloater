...
int main(int argc, char **argv)
{
  int tmp;
  {
    ...
    {
      {
        fprintf((FILE *__restrict ) stdout, (const char *__restrict ) "Error: Command line arguments are\n");
        fprintf((FILE *__restrict ) stdout, (const char *__restrict ) "Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid\n");
        fprintf((FILE *__restrict ) stdout, (const char *__restrict ) "Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt\n");
        fprintf((FILE *__restrict ) stdout, (const char *__restrict ) "Alt_Layer_Value, Up_Separation, Down_Separation\n");
        fprintf((FILE *__restrict ) stdout, (const char *__restrict ) "Other_RAC, Other_Capability, Climb_Inhibit\n");
        exit(1);
      }
    }
