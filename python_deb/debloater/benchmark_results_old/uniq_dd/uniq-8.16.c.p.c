...
extern double( strtod)(char const *__restrict __nptr,
...
extern int( fchown)(int __fd,
                                                                          __uid_t __owner,
                                                                          __gid_t __group);
extern int( lchown)(char const *__file,
                                                                                          __uid_t __owner,
                                                                                          __gid_t __group);
...
extern ssize_t( readlink)(char const *__restrict __path,
...
extern double( strtod_l)(char const *__restrict __nptr,
                                                                                                  char **__restrict __endptr,
                                                                                                  __locale_t __loc);
...
extern long( pathconf)(char const *__path,
                                                                                             int __name);
  ...
  {
    {
      ...
      fputs_unlocked((char const * )tmp, (FILE * ) stderr);
      i = (size_t)0;
    }
    {
      while (1) {
...
extern uintmax_t( strtoumax)(char const *__restrict __nptr,
                                                                                   char **__restrict __endptr,
                                                                                   int __base);
strtol_error xstrtoul(char const *s, char **ptr, int strtol_base, unsigned long *val,
                      char const *valid_suffixes);
extern unsigned long(
                                                                            strtoul)(char const *__restrict __nptr, char **__restrict __endptr,
                                                                                     int __base);
...
extern intmax_t( strtoimax)(char const *__restrict __nptr,
                                                                                  char **__restrict __endptr,
                                                                                  int __base);
extern char *( strndup)(char const *__string,
                                                                                              size_t __n) ;
...
void version_etc_arn(FILE *stream, char const *command_name, char const *package,
...

  {
    ...
    }
    {
      ...
      fputs_unlocked((char const * )tmp___0, (FILE * ) stream);
    }
    {
      if (n_authors == 0UL) {
        goto case_0;
    ...
    case_1 :
    {
      ...
      fprintf((FILE * ) stream, (char const * )tmp___1,
              *(authors + 0));
    }
      goto switch_break;
    case_2 :
    {
      ...
      fprintf((FILE * ) stream, (char const * )tmp___2,
              *(authors + 0), *(authors + 1));
    }
      goto switch_break;
    case_3 :
    {
      ...
      fprintf((FILE * ) stream, (char const * )tmp___3,
    ...
    case_4 :
    {
      ...
      fprintf((FILE * ) stream, (char const * )tmp___4,
    ...
    case_5 :
    {
      ...
      fprintf((FILE * ) stream, (char const * )tmp___5,
    ...
    case_6 :
    {
      ...
      fprintf((FILE * ) stream, (char const * )tmp___6,
              *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3), *(authors + 4),
              *(authors + 5));
    }
      goto switch_break;
    case_7 :
    {
      ...
      fprintf((FILE * ) stream, (char const * )tmp___7,
              *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3), *(authors + 4),
              *(authors + 5), *(authors + 6));
    }
      goto switch_break;
    case_8 :
    {
      ...
      fprintf((FILE * ) stream, (char const * )tmp___8,
              *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3), *(authors + 4),
    ...
    case_9 :
    {
      ...
      fprintf((FILE * ) stream, (char const * )tmp___9,
              *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3), *(authors + 4),
    ...
    switch_default :
    {
      ...
      fprintf((FILE * ) stream, (char const * )tmp___10,
              *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3), *(authors + 4),
              *(authors + 5), *(authors + 6), *(authors + 7), *(authors + 8));
    }
      goto switch_break;
...
extern int( futimens)(int __fd,
                                                                            struct timespec const *__times);
extern int( utimes)(char const *__file,
                                                                                          struct timeval const *__tvp);
extern int( futimesat)(int __fd,
                                                                             char const *__file,
                                                                             struct timeval const *__tvp);
...
extern int( mkdir)(char const *__path,
                                                                                         __mode_t __mode);
...
extern int( posix_spawn_file_actions_addopen)(posix_spawn_file_actions_t *__restrict __file_actions,
                                                                                                    int __fd,
                                                                                                    char const *__restrict __path,
                                                                                                    int __oflag,
                                                                                                    mode_t __mode);
...
extern int( settimeofday)(struct timeval const *__tv,
        ...
        switch_default___2:
          if (unibyte_locale) {
            ...
            }
            {
              ...
              while_continue___14: ;
                {
                  tmp___3 = mbrtowc((wchar_t * )(&w), (char const * )(arg + (i + m)),
...
extern long double( frexpl)(long double __x,
                                                                                  int *__exponent);
extern long double( ldexpl)(long double __x,
                                                                                  int __exponent);
extern double( frexp)(double __x,
                                                                            int *__exponent);
extern double( ldexp)(double __x,
                                                                            int __exponent);
...
int posix2_version(void) {
...

  {
    ...
    if (s) {
      if (*s) {
        {
          tmp___0 = strtol((char const * )s, (char ** )(&e),
                           10);
          i = tmp___0;
        }
        if (!*e) {
...
extern int( pipe2)(int *__pipedes,
                                                                         int __flags);
static int have_pipe2_really;
extern long( sysconf)(int __name);
extern int( setenv)(char const *__name,
                                                                                          char const *__value,
                                                                                          int __replace);
...
extern int( access)(char const *__name,
                                                                                          int __type);
...
extern FILE *( setmntent)(char const *__file,
                                                                                char const *__mode);
...
extern void *( mempcpy)(void *__restrict __dest,
                                                                                                 void const *__restrict __src,
                                                                                                 size_t __n);
extern int( wcswidth)(wchar_t const *__s,
                                                                            size_t __n);
...

  {
    ...
    if ((unsigned long)cp == (unsigned long)((void *)0)) {
      ...
      if ((unsigned long)file_name___3 != (unsigned long)((void *)0)) {
        {
          memcpy((void * )file_name___3, (void const * )dir,
                 dir_len___0);
        }
        if (add_slash) {
              ...
              while_continue: ;
                ...
                }
                {
                  strcpy((char * )(((res_ptr + res_size) - (l2 + 1UL)) - (l1 + 1UL)),
                         (char const * )(buf1));
                  strcpy((char * )((res_ptr + res_size) - (l2 + 1UL)), (char const * )(buf2));
                }
              __Cont:;
              }
            while_break: ;
...
static char const power_letter[9] =
    {(char const)0, (char const)'K', (char const)'M', (char const)'G',
     ...
     (char const)'Y'};
static char const *const block_size_args[3] = {(char const * ) "human-readable", (char const * ) "si", (char const * )0};
...
extern int( __fsetlocking)(FILE *__fp,
                                                                                 int __type);
...
extern int( fstatfs)(int __fildes,
                                                                                           struct statfs *__buf);
extern float( strtof)(char const *__restrict __nptr,
                                                                                            char **__restrict __endptr);
extern int( statfs)(char const *__file,
                                                                                             struct statfs *__buf);
    ...
    _L___0:
      ...
      _L:
        if (protect_err) {
          ...
          if (tmp___3) {
            {
              f = freopen((char const * )name, (char const * )mode,
                          (FILE * ) f);
            }
          } else {
            f = (FILE *)((void *)0);
  ...
  {
    {
      ...
      fputs_unlocked((char const * )tmp___2, (FILE * ) stdout);
  ...
  {
    {
      ...
      fprintf((FILE * ) stderr, (char const * )tmp, program_name);
    }
    return;
  }
}
...
static char const *const delimit_method_string[4] = {(char const * ) "none", (char const * ) "prepend", (char const * ) "separate", (char const * )((void *)0)};
...

  {
    if (status != 0) {
    ...
    } else {
      {
        ...
        fputs_unlocked((char const * )tmp___3, (FILE * ) stdout);
        tmp___4 = gettext("  -w, --check-chars=N   compare no more than N characters in lines\n");
        fputs_unlocked((char const * )tmp___4, (FILE * ) stdout);
        tmp___5 = gettext("      --help     display this help and exit\n");
        fputs_unlocked((char const * )tmp___5, (FILE * ) stdout);
        tmp___6 = gettext("      --version  output version information and exit\n");
        fputs_unlocked((char const * )tmp___6, (FILE * ) stdout);
        tmp___7 = gettext("\nA field is a run of blanks (usually spaces and/or TABs), then non-blank\ncharacters.  Fields are skipped before chars.\n");
        fputs_unlocked((char const * )tmp___7, (FILE * ) stdout);
        tmp___8 = gettext("\nNote: \'uniq\' does not detect repeated lines unless they are adjacent.\nYou may want to sort the input first, or use \'sort -u\' without \'uniq\'.\nAlso, comparisons honor the rules specified by \'LC_COLLATE\'.\n");
        fputs_unlocked((char const * )tmp___8, (FILE * ) stdout);
        emit_ancillary_info();
      }
    }
    {
...
static char * find_field(struct linebuffer const *line) {
  size_t count;
  char const *lp;
  size_t size;
  size_t i;
...
static void writeline(struct linebuffer const *line, _Bool match, uintmax_t linecount) {
...

  {
    ...
    if ((unsigned int)countmode == 0U) {
      {
        printf((char const * ) "%7lu ", linecount + 1UL);
      }
    }
    {
      fwrite_unlocked((void const * )line->buffer, sizeof(char), (size_t)line->length,
                      (FILE * ) stdout);
    }
    return;
  }
        ...
        if ((unsigned int)countmode == 1U) {
          {
            ...
            while_continue: ;
              ...
              if (prevline->length == 0UL) {
                ...
                if (tmp___6) {
                _L : {
                  fwrite_unlocked((void const * )thisline->buffer, sizeof(char),
                                  thisline->length, (FILE * ) stdout);
                }
                  {
                    while (1) {
                    while_continue___0: ;
